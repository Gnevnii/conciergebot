...
@Component
public class GetBottomNeighborCommand extends AbstractPrivateChatReaction {
    private final UserRepository userRepository;

    @Autowired
    public GetBottomNeighborCommand(final UserRepository userRepository) {
    ...
    public Command getCommand() {
        return Command.NEIGHBOORBOTTOM;
    }
    ...
    public void react(final Update update, final BiConsumer<Long, Object> sender, final String commandLine) {
        ...
        final String users = concatUserNames(userRepository.getBottomUserUsers(userId)
                .stream()
